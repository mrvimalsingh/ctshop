...
class CI_Cart {
	...
	function _save_cart()
	{
		...
		foreach ($this->_cart_contents as $key => $val)
		{
			...
			// Set the subtotal
//			echo "subtotal: ".$this->_cart_contents[$key]['price']." * ".$this->_cart_contents[$key]['qty']." = ".($this->_cart_contents[$key]['price'] * $this->_cart_contents[$key]['qty']);
